...
<div class="container-fluid fixed-top">
    <div class="topbar d-none bg-dark d-lg-block">
    ...
    <div class="container px-0">
        <nav class="navbar navbar-light bg-black navbar-expand-xl">
            @foreach($web_information as $obj)
            <h1 class="display-6" style="color: #45595b">{{$obj->web_name}}</h1>
            @endforeach
